function [SS_updated,log_Wbar_updated] = forwardFilteringCSMCRecursion(n,N,tau_star,SS_nm1,log_W_nm1,params)
...
% tau_star: 1 x |tau|       vector of conditioning changepoints
...
%Wbar_n_nm1 = gn(n,n-1,params)sum(summand_arr);
